    ...
    <div className={sliderClass}>
      ...
      >
        <div className={css.sliderItem}>
          <Image src={require('./person1.png')} alt="" />
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person2.png')} alt="" />
          <div className={css.sliderContent}>
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person3.png')} alt="" />
          <div className={css.sliderContent}>
            <p>工程精英 豪宅實力 優秀品質</p>
            <h3>公務協理 馮志華</h3>
          </div>
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person4.png')} alt="" />
          <div className={css.sliderContent}>
            <p>英雄盛會 獨領風騷 雄霸江翠</p>
            <h3>董事長 賴運興</h3>
          </div>
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person5.png')} alt="" />
          <div className={css.sliderContent}>
            <p>工程精英 豪宅實力 優秀品質</p>
            <h3>公務經理 劉春平</h3>
          </div>
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person6.png')} alt="" />
          <div className={css.sliderContent}>
        ...
        <div className={css.sliderItem}>
          <Image src={require('./person7.png')} alt="" />
          <div className={css.sliderContent}>
            <p>公設名家 華人之光 金獎名家 橫掃亞太</p>
            <h3>主持設計師 林之豐</h3>
          </div>
