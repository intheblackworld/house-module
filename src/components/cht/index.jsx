  ...
  <div className={withTrans('row', c, show)}>
    {items.map(item => (
      <div className={c.item} key={item.src}>
        ...
        <img src={item.src} alt="正義聯盟的圖片" className={c.itemImg} />
        ...
        <div key={`accord-${item.src}`}>
          ...
          >
            <div className={c.head}>
              ...
              <img src={require('./down.png')} alt="正義聯盟的圖片" className={c.icon} />
            </div>
          </Accordion.Title>
          <Accordion.Content active={activeIndex === index} className={c.accordionContent}>
            <img src={item.src} alt="正義聯盟的圖片" />
          </Accordion.Content>
        </div>
      ))}
    </Accordion>
