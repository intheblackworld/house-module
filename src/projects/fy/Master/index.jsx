...
const Master = () => (
  <div className={css['master-carousel-wrap']}>
    <Image src={leaf1} alt="" className={css.leaf1} />
    <Image src={leaf2} alt="" className={css.leaf2} />
    <Image src={leaf3} alt="" className={css.leaf3} />
    <Carousel>
      <div>
        <div className={css.imageTitle}>新板巨星</div>
        <div className={css.imgWrap}>
          <Image src={bg3} alt="" className={css.bgImage} />
        </div>
      ...
      {/* <div>
        <div className={css.imgWrap}>
          <Image src={bg1} alt="" className={css.bgImage} />
        </div>
        <h3>超低頭款，立即入住</h3>
      </div> */}
