  ...
  return (
    <React.Fragment>
      <div className={imgClass}>
        <Image src={company1} alt="博悅的圖片" />
        <Image src={cross} alt="博悅的圖片" />
        <Image src={company2} alt="博悅的圖片" />
      </div>
...
const BuildImgs = ({ show = false }) => {
  ...
  return <img src={bg1} alt="博悅的圖片" className={buildingClass} />
}
