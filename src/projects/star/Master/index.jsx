  ...
  return (
    <div className={c.bg}>
      ...
      <div className={leftEffectClass}>
        ...
        <img className={c.like} src={require('./like.png')} alt="博悅的圖片" />
        <img className={c.flower} src={require('./flower.png')} alt="博悅的圖片" />
      ...
      <div className={c.main}>
        ...
        <img className={brotherClass} src={require('./brother.png')} alt="博悅的圖片" />
        {isMobile && (
          <Link
            className={c.link}
            to="point2"
      ...
      <div className={rightEffectClass}>
        <img className={c.flower} src={require('./flower.png')} alt="博悅的圖片" />
        <img className={c.surprise} src={require('./surprise.png')} alt="博悅的圖片" />
        <img className={c.love} src={require('./love.png')} alt="博悅的圖片" />
        <img className={c.flower} src={require('./flower.png')} alt="博悅的圖片" />
        <img className={c.smile} src={require('./smile.png')} alt="博悅的圖片" />
        <img className={c.smile} src={require('./smile.png')} alt="博悅的圖片" />
        <img className={c.love} src={require('./love.png')} alt="博悅的圖片" />
      </div>
    </div>
