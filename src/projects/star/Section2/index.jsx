...
const TitleHeader = ({ show }) => {
  ...
  return (
    <div className={c.titleHeader}>
      <img src={require('./star.png')} alt="東城大境的圖片" className={c.star} />
  ...
  <div className={withTrans('item', c, show)}>
    ...
    <div className={c.content}>
      ...
      <div className={c.img1}>
        <img src={require('./brother1.png')} alt="東城大境的圖片" />
      </div>
    </div>
    <Link
      className={c.link}
  ...
  <div className={withTrans('item', c, show)}>
    ...
    <div className={c.content}>
      ...
      <div className={c.img2}>
        <img src={require('./brother2.png')} alt="東城大境的圖片" />
      </div>
    </div>
    <Link
      className={c.link}
  ...
  <div className={withTrans('item', c, show)}>
    ...
    <div className={c.content}>
      ...
      <div className={c.img3}>
        <img src={require('./brother3.png')} alt="東城大境的圖片" />
      </div>
    </div>
    <Link
      className={c.link}
