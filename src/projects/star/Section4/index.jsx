...
const OhYa = ({ show }) => (
  <div className={withTrans('ohya', c, show)}>
    ...
    <div className={c.leftBrothers}>
      ...
      {!isMobile && <img src={require('./leftBrother.png')} alt="" />}
      {!isMobile && <img src={require('./leftBrother.png')} alt="" />}
    </div>
    <div className={c.rightBrothers}>
      <img src={require('./rightBrother.png')} alt="" />
      {!isMobile && <img src={require('./rightBrother.png')} alt="" />}
      {!isMobile && <img src={require('./rightBrother.png')} alt="" />}
    </div>
  </div>
)
...
const OhYaTitle = ({ show }) => (
  <img src={require('./ohyaTitle.png')} alt="" className={withTrans('ohyaTitle', c, show)} />
)
...
const Present = ({ show }) => (
  <Fragment>
    <img src={require('./present.png')} alt="" className={withTrans('present', c, show)} />
