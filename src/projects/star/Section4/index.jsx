...
const OhYa = ({ show }) => (
  <div className={withTrans('ohya', c, show)}>
    ...
    <div className={c.sayGroup}>
      <img src={require('./say1.png')} alt="帝璽的圖片" className={c.say1} />
      <img src={require('./say2.png')} alt="帝璽的圖片" className={c.say2} />
    </div>
    <div className={c.leftBrothers}>
      <img src={require('./leftBrother.png')} alt="帝璽的圖片" />
      {!isMobile && <img src={require('./leftBrother.png')} alt="帝璽的圖片" />}
      {!isMobile && <img src={require('./leftBrother.png')} alt="帝璽的圖片" />}
    </div>
    <div className={c.rightBrothers}>
      <img src={require('./rightBrother.png')} alt="帝璽的圖片" />
      {!isMobile && <img src={require('./rightBrother.png')} alt="帝璽的圖片" />}
      {!isMobile && <img src={require('./rightBrother.png')} alt="帝璽的圖片" />}
    </div>
  </div>
)
...
const OhYaTitle = ({ show }) => (
  <img src={require('./ohyaTitle.png')} alt="帝璽的圖片" className={withTrans('ohyaTitle', c, show)} />
)
...
const Present = ({ show }) => (
  <Fragment>
    <img src={require('./present.png')} alt="帝璽的圖片" className={withTrans('present', c, show)} />
...
export const Desc = ({ show }) => (
  <Fragment>
    <img src={require('./notice.png')} alt="帝璽的圖片" className={c.notice} />
    <Element id="point7" />
