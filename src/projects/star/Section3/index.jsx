...
const Task1 = ({ show }) => (
  <div className={withTrans('task1', c, show)}>
    ...
    <img src={require('./brother1.png')} alt="正義聯盟的圖片" className={c.brother1} />
    <img src={require('./brother11.png')} alt="正義聯盟的圖片" className={c.brother11} />
    ...
    <div className={c.steps}>
      <div className={c.item}>
        ...
        <div className={c.icon1}>
          <img src={require('./step1.png')} alt="正義聯盟的圖片" />
        </div>
        <div className={c.desc}>到新板巨星 FB 按讚追蹤</div>
      </div>
      {!isMobile && <img src={require('./arrowRight.png')} alt="正義聯盟的圖片" className={c.arrowRight} />}
      <div className={c.item}>
        <div className={c.label}>Step 2</div>
        <div className={c.icon2}>
          <img src={require('./step2.png')} alt="正義聯盟的圖片" />
        </div>
      ...
      <div className={c.item}>
        ...
        <div className={c.icon3}>
          <img src={require('./step3.png')} alt="正義聯盟的圖片" />
        </div>
...
const Task2 = ({ show }) => {
  ...
  return (
    <div className={withTrans('task2', c, show)}>
      ...
      <img src={require('./brother2.png')} alt="正義聯盟的圖片" className={c.brother2} />
      ...
      <div className={c.steps}>
        ...
        {!isMobile && <img src={require('./arrowDown.png')} alt="正義聯盟的圖片" className={c.arrowDown} />}
        <div className={c.item}>
          <div className={c.label}>Step 2</div>
          <div className={c.desc}>
      ...
      <div className={c.carousel}>
        ...
        {slideIndex === 2 ? <img src={require('./frame.png')} alt="正義聯盟的圖片" className={c.frame} /> : ''}
        <Carousel
          slidesToShow={1}
          fade={false}
          arrows
        ...
        >
          <img src={require('./slide1.png')} alt="正義聯盟的圖片" />
          <img src={require('./slide2.png')} alt="正義聯盟的圖片" />
          <img src={require('./slide3.png')} alt="正義聯盟的圖片" />
        </Carousel>
...
const Task3 = ({ show }) => (
  <div className={withTrans('task3', c, show)}>
    ...
    <img src={require('./brother3.png')} alt="正義聯盟的圖片" className={c.brother3} />
    <img src={require('./brother31.png')} alt="正義聯盟的圖片" className={c.brother31} />
