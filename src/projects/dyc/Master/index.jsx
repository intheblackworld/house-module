  ...
  return (
    <div className={c.bg}>
      <div className={c.leaf}>
        <img className={leftLeafClass} src={require('./flower-left.png')} alt="博悅的圖片" />
        ...
        <img className={rightLeaf1Class} src={require('./flower-right1.png')} alt="博悅的圖片" />
        <img className={rightLeaf2Class} src={require('./flower-right2.png')} alt="博悅的圖片" />
      </div>
    </div>
  )
}
