  ...
  return (
    <div className={sideBarClass}>
      {slideList.map((slide, index) => (
        ...
        >
          <img src={require('./fan.png')} alt="博悅的圖片" />
...
const Slider = ({ show, index = 0 }) => {
  ...
  return (
    <div className={sliderClass}>
      ...
      <img className={c.blockImg} src={slideList[index].src} alt="博悅的圖片" />
...
const Section5 = () => {
  ...
  return (
    <div className={c.bg}>
      <img src={require('./leftFlower.png')} alt="博悅的圖片" className={c.leftFlower} />
      <img src={require('./rightFlower.png')} alt="博悅的圖片" className={c.rightFlower} />
