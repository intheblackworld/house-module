  ...
  return (
    <div className={sideBarClass}>
      {slideList.map((slide, index) => (
        ...
        >
          <img src={require('./fan.png')} alt="帝璽的圖片" />
...
const Section5 = () => {
  ...
  return (
    <div className={c.bg}>
      <img src={require('./leftFlower.png')} alt="帝璽的圖片" className={c.leftFlower} />
      <img src={require('./rightFlower.png')} alt="帝璽的圖片" className={c.rightFlower} />
