...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      title: '帝璽 | 宏盛長虹建北鋼骨地標| 官網',
      metaTitle: '帝璽 | 宏盛長虹建北鋼骨地標| 官網',
      metaDescription:
        '雙龍頭品牌攜手，稀世556坪全街廓、超世代鋼骨摩天宅，建北王座即是帝璽。接待中心:台北市中山區建國北路二段76號，禮賓專線:(02)2516-5888',
      metaKeywords: '帝璽,台北建案,台北買房,中山區建案,中山區新建案,中山區買房',
      ogMetaTitle: '帝璽 | 宏盛長虹建北鋼骨地標| 官網',
      ogMetaType: 'website',
      ogMetaDescription:
        '雙龍頭品牌攜手，稀世556坪全街廓、超世代鋼骨摩天宅，建北王座即是帝璽。接待中心:台北市中山區建國北路二段76號，禮賓專線:(02)2516-5888',
      template: 'index.html',
